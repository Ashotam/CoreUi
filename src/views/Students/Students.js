    ...
    <div>
      {!isOpenedCreate && !isopenedEdit && (
        <Row>
          ...
          <Col>
            <Card>
              <CardHeader>Student Table</CardHeader>
              ...
              <CardBody>
                ...
                >
                  <Button color="success" onClick={openCreateStudent}>
                    Create Student
                  </Button>
                </Col>
                <Table responsive>
      ...
      {isOpenedCreate && (
        <Card>
            ...
            <Form action="" method="post">
              <FormGroup>
                ...
                <Input
                  ...
                  id="name"
                  name="name"
                  invalid={studentName.length < 4 && error.nameError}
                  value={studentName}
                  onChange={(e) => {
                ...
                <Input
                  ...
                  id="lastname"
                  name="lastname"
                  invalid={studentLastName.length < 4 && error.lastNameError}
                ...
                <Input
                  ...
                  id="email"
                  name="email"
                  invalid={!validateEmail(studentEmail) && error.emailError}
                  value={studentEmail}
                  onChange={(e) => {
                ...
                <Input
                  ...
                  id="phone"
                  name="phone"
                  invalid={!validatePhone(studentPhone) && error.phoneError}
                  value={studentPhone}
                  onChange={(e) => {
                ...
                <Col xs="18" md="15">
                  <Input
                    ...
                    name="selectFaculty"
                    id="selectFaculty"
                    invalid={selectedFac.length === 0 && error.facultyError}
                    onChange={(e) => {
                      setSelectedFac(e.target.value);
                    }}
                  >
                ...
                <Col xs="18" md="15">
                  <Input
                    ...
                    name="selectGroup"
                    id="selectGroup"
                    invalid={selectedGroup.length === 0 && error.groupError}
                    onChange={(e) => {
          ...
          >
            <Button color="success" className="mr-2" onClick={addHendler}>
              Save
            </Button>
            <Button
              color="danger"
      ...
      {isopenedEdit && (
        <Card>
          <CardHeader>Edit Student</CardHeader>
          <CardBody>
            <Form action="">
              <FormGroup>
                <Label>
          ...
          <Col
            ...
            className="mb-4 mb-xl-2 d-flex justify-content-end pr-4"
          >
            <Button color="success" className="mr-2" onClick={editStudent}>
              Save
            </Button>
            <Button
              color="danger"
